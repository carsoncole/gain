...
class TradeTest < ActiveSupport::TestCase
  ...
  test "quantity balance for sequential BUY trades" do
    ...
    assert_equal 100, trade.quantity_balance

    trade = create(:trade, account: @account, quantity: 150, security: @security)
    assert_equal 250, trade.quantity_balance

    trade = create(:trade, account: @account, quantity: 25, security: @security)
    assert_equal 275, trade.quantity_balance
  end

  test "quantity balance for sequential SELL trades" do
    trade = create(:trade, account: @account, security: @security, quantity: 25)
    assert_equal 25, trade.quantity_balance

    trade = create(:trade, account: @account, quantity: 15, security: @security)
    assert_equal 40, trade.quantity_balance
  end
  ...
  test "quantity balance on non sequential entered day BUY trades" do
    ...
    assert_equal 25, trade_3.quantity_balance

    trade_1 = create(:trade, account: @account, quantity: 150, security: @security, date: Date.today- 2.days)
    assert_equal 150, trade_1.quantity_balance

    trade_3.reload
    assert_equal 175, trade_3.quantity_balance

    trade_2 = create(:trade, account: @account, security: @security, quantity: 10, date: Date.today- 2.days)
    assert_equal 160, trade_2.quantity_balance
    trade_3.reload
    assert_equal 185, trade_3.quantity_balance
  end
  ...
  test "quantity balance updated BUY trades" do
    ...
    assert_equal 25, trade_2.quantity_balance
    assert_equal 50, trade_3.quantity_balance
  ...
  test "quantity balance updated BUY to SELL trade" do
    ...
    assert_equal -5, trade_2.quantity_balance
