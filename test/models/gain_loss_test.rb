...
class GainLossTest < ActiveSupport::TestCase
  ...
  test "split followed by sell" do
    trade_1 = create(:buy_trade, quantity: 10, price: 10)
    trade_2 = create(:split_trade, account: trade_1.account, security: trade_1.security, split_new_shares: 100)
    trade_3 = create(:sell_trade, quantity: 10, price: 1, account: trade_1.account, security: trade_1.security)
    assert_equal 90, trade_3.reload.quantity_balance
    assert_equal 0, trade_3.quantity_tax_balance
    assert_equal 90, trade_1.reload.quantity_tax_balance
    assert_equal 0, trade_1.cost_tax_balance
  end
end
