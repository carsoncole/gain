...
class GainLossTest < ActiveSupport::TestCase
  ...
  test "single partial closing trade" do
    trade_1 = create(:trade, account: @account, security: @security, quantity: 100, price: 10, trade_type: 'Buy')
    trade_2 = create(:trade, account: @account, security: @security, quantity: 50, price: 20, trade_type: 'Sell')
    assert_equal 1, @account.gain_losses.count
  ...
  test "multiple gains generated by one trade" do
    trade_1 = create(:trade, account: @account, security: @security, quantity: 100, price: 10, trade_type: 'Buy')
    trade_2 = create(:trade, account: @account, security: @security, quantity: 100, price: 20, trade_type: 'Buy')
    trade_3 = create(:trade, account: @account, security: @security, quantity: 150, price: 40, trade_type: 'Sell')
  ...
  test "selling then overbuying" do
    create(:sell_trade, account: @account, security: @security, quantity: 10, price: 20)
    create(:buy_trade, account: @account, security: @security, quantity: 20, price: 10)
    assert_equal 100, @account.gain_losses.first.amount
  end
